...
export const constantRoutes = [
  ...
  {
    path: '/rtmp',
    component: () => import('@/views/rtmp/index'),
    hidden: true
  },
  {
    path: '/404',
...
// http://localhost:9527/#/my/exam/result/28/1
/**
 * asyncRoutes
...
export const asyncRoutes = [
  ...
  {
    path: '/exam/studentPrepare/:examId',
...

  {
    ...
    children: [

      {
        ...
        name: 'ExamOnline',
        meta: { title: '在线比赛', noCache: true, icon: 'guide' }
      },
      ...
      {
        path: 'exam/result/:examId&:userId',
        component: () => import('@/views/paper/exam/result'),
        name: 'ShowExam',
...

  {
    ...
    children: [

      {
        ...
        name: 'ListRepo',
        meta: { title: '赛卷管理', noCache: true, icon: 'repo' }
      },

      {
        ...
        name: 'AddRepo',
        meta: { title: '添加试卷', noCache: true, activeMenu: '/exam/repo' },
        hidden: true
      },

      {
        ...
        component: () => import('@/views/qu/repo/form'),
        name: 'UpdateRepo',
        meta: { title: '试卷详情', noCache: true, activeMenu: '/exam/repo' },
        hidden: true
      },

      {
        ...
        name: 'ListQu',
        meta: { title: '赛题管理', noCache: true, icon: 'support' }
      },
...

      {
        ...
        name: 'ListExam',
        meta: { title: '比赛管理', noCache: true, icon: 'log' }
      },
