  ...
  <div class="app-container">
    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" label-position="left" label-width="150px">
      ...
      <el-card>
        ...
        <el-form-item label="题目编码" prop="code">
        ...
        <el-form-item v-if="postForm.quType==4" label="答案图片">
          <file-upload v-model="postForm.scimage" accept=".jpg,.jepg,.png" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        code: [
          { required: true, message: '题目编码不能为空！' }
        ],
        content: [
