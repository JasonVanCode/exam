...
type Register struct {
	...
	Identification string `gorm:"column:identification" json:"identification"` //身份证号码
...
type Registers struct {
	...
	RoleIds        string `gorm:"column:role_ids" json:"role_ids"`             //角色列表
	DepartId       int    `gorm:"column:departId" json:"departId"`             //部门ID
	State          int    `gorm:"column:state" json:"state"`                   //状态
	DataFlag       int    `gorm:"column:data_flag" json:"data_flag"`           //0正常,1隐藏
}

// User login structure
type Loginexa struct {
